### Trials for comparing type I error between t-test and test through balanced permutation
...
ggplot(data = plot_data, aes(x = alpha, y = `false rejections`, color = method)) + geom_line() + geom_abline(slope = 1, intercept = 0)
